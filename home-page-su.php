...
<main>
  ...
  <section class="gallery" id="gallery">
    ...
    <div class="gallery__container">
      ...
      <figure><a class="grid-item" data-fslightbox href="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg"> <img class="gallery__item" src="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg" alt=""></a></figure>
      <figure><a class="grid-item" data-fslightbox href="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg"><img class="gallery__item" src="<? echo get_template_directory_uri(); ?>/assets/img/hero-3.jpg" alt=""></a></figure>
      <figure><a class="grid-item" data-fslightbox href="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg"> <img class="gallery__item" src="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg" alt=""></a></figure>
      <figure><a class="grid-item" data-fslightbox href="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg"> <img class="gallery__item" src="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg" alt=""></a></figure>
      <figure><a class="grid-item" data-fslightbox href="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg"> <img class="gallery__item" src="<? echo get_template_directory_uri(); ?>/assets/img/hero-5.jpg" alt=""></a></figure>
